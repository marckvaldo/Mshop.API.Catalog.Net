...
{
    public class CategoryRemovedEventHandler : IDomainEventHandler<CategoryRemovedEvent>
    {
        private readonly IServiceCacheCategory _serviceCacheCategory;
        public CategoryRemovedEventHandler(IServiceCacheCategory serviceCacheCategory)
        {
            _serviceCacheCategory = serviceCacheCategory;
        }

        public async Task<bool> HandlerAsync(CategoryRemovedEvent domainEvent)
        {
            ...
            await _serviceCacheCategory.RemoveCategory(domainEvent.Id, CancellationToken.None);
            return true;
        }
    }
}
